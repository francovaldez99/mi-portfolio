  ...
  return (
          ...
          <article className='inicio-text-container'>
            ...
            <div className='inicio-btn-container'>
                ...
                <a href="https://drive.google.com/file/d/1qL_joUdTYi6un-KqfxhVNv5mlU-WHe3e/view?usp=sharing" target="_blank" rel="noreferrer" className="contact-button descagar-cv"><MdFileUpload/> Descargar CV</a>
